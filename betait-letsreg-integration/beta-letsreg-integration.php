 ...
 */
define( 'BETAIT_LETSREG_VERSION', '1.0.0' );

/**
 * The code that runs during plugin activation.
 * This action is documented in includes/class-betait-letsreg-activator.php
 */
 ...
 * This action is documented in includes/class-betait-letsreg-deactivator.php
 */
...
register_deactivation_hook( __FILE__, 'deactivate_betait_letsreg' );

/**
 * The core plugin class that is used to define internationalization,
 * admin-specific hooks, and public-facing site hooks.
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-betait-letsreg.php';
